...
public class VerficationsCodesEmployerManager implements VerificationsCodesService{
	String code;
	private VerificationsCodesDao verficationsCodesDao;
	
	
@Autowired
	public VerficationsCodesEmployerManager(VerificationsCodesDao verficationsCodesDao) {
	super();
